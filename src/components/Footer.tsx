...
export default function Footer() {
  return (
    <footer className="border-t border-border">
      <div className="mx-auto max-w-6xl px-6 py-12 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="font-mono text-[11px] tracking-widest uppercase text-muted mb-1">
            CPO @ Bullish · Building at the intersection of finance and technology
          </p>
